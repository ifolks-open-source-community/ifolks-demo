...
constructor(private service:CityRestClient, private route: ActivatedRoute, private formBuilder: FormBuilder, private dialog: MatDialog, private notifications: NotificationService) {
this.id = parseInt(this.route.snapshot.paramMap.get('id'));
this.activePath = '/region/' + this.id.toString() + '/city/list';
}
ngOnInit(): void {
...
refresh(): void {
this.service.scrollFromRegion(this.id, this.scrollForm).subscribe((t) => {
this.scrollView=t;
