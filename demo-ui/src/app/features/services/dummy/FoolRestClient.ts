...
return this.http.get<SelectItem[]>(environment.restApiUrl + '/fool/options/search', {params:{'arg':arg}});
}
...
return this.http.post(environment.restApiUrl + '/fool', form, { ...this.httpOptions, responseType: 'text' });
}
